...
public:
    slider_with_label(double minimum = -90) : _slider(minimum)
    {
        ...
        _label.setFont(Font("SF Pro Text", 13, Font::FontStyleFlags::plain));
        ...
        _label_value.setFont(Font("SF Pro Text", 11, Font::FontStyleFlags::plain));
    ...
    void resized() override
    {
        ...
        _label_value.setBounds(bounds.removeFromRight(50));
